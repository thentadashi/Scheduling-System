                            ...
                            <div class="col-md-12 m-b-30">
                                ...
                                <div class="d-block d-sm-flex flex-nowrap align-items-center">
                                    <div class="page-title mb-2 mb-sm-0">
                                        <h1><i class="fa fa-joomla"></i> Edit Room</h1>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card card-statistics">
                                    <div class="card-body p-0">
                                        ...
                                        <?php
                                            $query = mysqli_query($con,"select * from room where roomid='$get_id'") or die("Cannot Connect to Database".mysqli_connect_error());
                                            ...
                                            <div class="col-xl-9 col-md-8 col-12 border-t border-right">
                                                <div class="page-account-form">
                                                    <div class="form-titel border-bottom p-3">
                                                        <h5 class="mb-0 py-2">Edit Room</h5>
                                                    </div>
                                                    <div class="p-4">
                                                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                                            <div class="form-row"><h5 class="mb-0 py-2"><i class="fa fa-joomla"></i> Room Information</h5>
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control" id="location" name="location" value="<?php echo $row['location']; ?>" maxlength="11">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="email1">Department</label>
                                                                    <input type="department" class="form-control" id="department" name="department" value="<?php echo $row['department']; ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <a href="room.php" class="btn btn-danger">Back</a>
                                                        </form>
                                                        <?php
                                                            if (isset($_POST['update'])) 
                                                            {
                                                                ...
                                                                mysqli_query($con,"update room set room_name='$room_name',description='$description',location='$location', department='$department' where roomid='$get_id'") 
                                                                or die("Cannot Connect to Database".mysqli_connect_error());
                                                                echo "<script type='text/javascript'>".
                                                                        "alert('Update Successful, Please Reload!');
                                                                        location.replace('edit_room.php?id=$get_id');".
                                                                        "</script>";
                                                            }
                                                        ?>
                                                    </div>
