                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <?php include 'modals/preview_me_schedule.php'?>
                                        <div class="card-body">
                                                <button class="btn btn-primary mb-2 mr-2 col-2" data-toggle="modal" data-target="#preview_me_schedule"><i class="fa fa-calendar"></i> Preview My Schedule</button>
                                            <div class="datatable-wrapper">
                                                ...
                                                <table id="datatable2" class="display compact table table-striped table-bordered" style="font-size:1rem;color:#666;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $query = mysqli_query($con,"SELECT * FROM classsched WHERE status='checked' AND fname LIKE '%" . $ins . "%'")
