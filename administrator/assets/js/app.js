        ...
        if (morrisJS.length > 0) {
                    ...
                    if (morrisdemo4.length > 0) {
                        Morris.Donut({
                            element: morrisdemo4,
                            data: [
                                { label: "Call Type 1", value: 20 },
                                { label: "Call Type 2", value: 30 },
                                { label: "Call Type 3", value: 20 },
                                { label: "Call Type 4", value: 20 },
                                { label: "Call Type 5", value: 30 }
                            ],
                            colors: ['#45aaf2', '#e3324c', '#fbaf54','#4776E6', '#8E54E9']
                        });
                    }
