                    ...
                    <div class="row col-12">
                        <div class="control-group col-4">
                            ...
                            <div class="controls">
                                ...
                                <input type="time" id="appt" name="time_start" class="form-control" value="08:00:00" min="08:00" max="17:00" required>
                            </div>
                        </div>
                        ...
                        <div class="control-group col-4">
                            ...
                            <div class="controls">
                                ...
                                <input type="time" id="time2"  name="time_end" class="form-control" value="8:00:00" min="08:00" max="17:00" required>
                            </div> 
                        </div>
                        <div class="control-group col-4">
